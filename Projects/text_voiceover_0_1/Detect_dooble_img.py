...
#            old_img = Image.new('RGB', (250, 250), (255, 255, 255))
    ...
    #print(hash1)
    #print(hash2)
    #print(CompareHash(hash1, hash2)) # 0 - полное совпадение

    if (CompareHash(hash1, hash2)) > 4:
        img = Image.open('example.png')
        img.save('old_example.png')
        #print('НОВЫЙ КАДР ПЕРЕЗАПИСАН')
    else:
        #img = Image.new('RGB', (250, 250), (255, 255, 255))
        #img.save('example.png')
        #print('КАДР НЕ ПОМЕНЯЛСЯ - ПРОПУСК ЦИКЛА, отчистка кадра')
        return True
